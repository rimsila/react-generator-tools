      ...
      >
        <Form form={form} onFinish={handleFinish} {...formLayout}>
          <Form.Item
            ...
            name="importConfig"
            required
            rules={[{ required: true, message:'Please enter the configuration parameters you want to import' }]}
          >
            <Input.TextArea cols={10} placeholder="Please enter the configuration parameters you want to import" />
          </Form.Item>
        </Form>
      </Modal>
    </>
